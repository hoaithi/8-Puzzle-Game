...
def Greedy(start_node):
    ...
    heapq.heappush(frontier, (greedy_heuristic(start_node), start_node))
    ...
    while frontier:
        ...
        for neighbor in node.nodes:
            if neighbor.state not in explored_nodes:
                ...
                neighbor_heuristic = greedy_heuristic(neighbor)
                heapq.heappush(frontier, (neighbor_heuristic, neighbor))
                explored_nodes.add(neighbor.state)
